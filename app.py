...
def main():
    st.set_page_config(page_title = 'Telemarketing analisys', \
        page_icon = 'https://www.insil.com.au/wp-content/uploads/2020/01/featureimage20.jpg',
        layout="wide",
        initial_sidebar_state='expanded'
    )
    st.write('# Analise de uma campanha de telemarketing')
    st.write('Atualmente, os gastos de marketing no setor bancário são enormes, \
    o que significa que é essencial que os bancos otimizem as estratégias de marketing e melhorem a eficácia. \
    Compreender a necessidade dos clientes leva a planos de marketing mais eficazes, \
    designs de produtos mais inteligentes e maior satisfação do cliente.')
    st.markdown("---")
    
    image = 'https://cdn.outsource2india.com/callcenter/images/18-tips-to-make-your-telemarketing-scripts-work.jpg'
    ...
    if (data_file_1 is not None):
        ...
        st.download_button(label='📥 Baixar tabela filtrada',
                            data=df_xlsx ,
